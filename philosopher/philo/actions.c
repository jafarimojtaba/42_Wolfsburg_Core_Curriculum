...
/*   Updated: 2022/06/22 12:06:03 by mjafari          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_death(t_philo *ph)
{
	...
	pthread_mutex_lock(&ph->rules->forks[207]);
	// i = 0;
	// while (i < r->nb_philo)
	// {
		...
		// i++;
	// }
	pthread_mutex_unlock(&ph->rules->forks[207]);
	return (0);
}
...
void	sleeping(t_philo *ph)
{
	...
	{
		// pthread_mutex_lock(&r->forks[201]);
		// r->all_ate += 1;
		// pthread_mutex_unlock(&r->forks[201]);
		ph->ate_enough = 1;
	}
